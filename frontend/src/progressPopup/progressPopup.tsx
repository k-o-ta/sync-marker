...
const ProgressPopup: React.FC = () => {
  ...
  return (
      <ProgressPopupContext.Provider value={{status: progressState, setStatus: (popup: ProgressPopupStatus, isbn?: string, pageCount?: number) => {setProgressState({popup, isbn, pageCount})}}}>
          {dom}
